...
export const CreateStrengthExerciseSchema =
	createInsertSchema(strengthExercises);
export const SelectStrengthExerciseSchema =
	createSelectSchema(strengthExercises);
